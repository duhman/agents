 ...
 */
export declare function getVectorStoreContext(
 ...
 */
export declare function extractPaymentGuidanceFromContext(
  context: string[],
  language: string
): string | null;
/**
 ...
 */
export declare function extractToneGuidanceFromContext(
  context: string[],
  language: string
): {
  empathetic: boolean;
 ...
 */
export declare function enhanceDraftWithRagInsights(
  baseDraft: string,
  context: string[],
  extraction: ExtractionResultEnhanced
): string;
