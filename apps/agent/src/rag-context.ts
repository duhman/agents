...
export function extractPaymentGuidanceFromContext(
  ...
  if (firstContext.includes('refund') || firstContext.includes('refusjon') || firstContext.includes('återbetalning')) {
    if (language === "no") {
  ...
  if (firstContext.includes('double') || firstContext.includes('dobbel') || firstContext.includes('dubbel')) {
    if (language === "no") {
  ...
  if (firstContext.includes('feil') || firstContext.includes('error') || firstContext.includes('fel')) {
    if (language === "no") {
...
export function enhanceDraftWithRagInsights(
  ...
  if (toneGuidance.apologetic && !enhancedDraft.toLowerCase().includes('beklager') && !enhancedDraft.toLowerCase().includes('sorry')) {
    if (extraction.language === "no") {
  ...
  if (toneGuidance.empathetic && !enhancedDraft.toLowerCase().includes('forstår') && !enhancedDraft.toLowerCase().includes('understand')) {
    if (extraction.language === "no") {
      enhancedDraft = enhancedDraft.replace(
        "Vi forstår", 
        "Vi forstår og sympatiserer med"
      );
    } else if (extraction.language === "en") {
      enhancedDraft = enhancedDraft.replace(
        "We understand", 
      ...
      enhancedDraft = enhancedDraft.replace(
        "Vi förstår", 
        "Vi förstår och sympatiserar med"
      );
    }
  }
