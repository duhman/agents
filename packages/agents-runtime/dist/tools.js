...
export const createDraftTool = tool({
    ...
    execute: async (params) => {
        try {
            ...
            logInfo("Draft created successfully", { requestId: "tool-execution" }, {
                draftId: draft.id,
                ticketId: params.ticketId,
...
export const calculateConfidenceTool = tool({
    ...
    execute: async ({ extraction }) => {
        try {
            ...
            logInfo("Confidence calculated", { requestId: "tool-execution" }, {
...
export const extractEmailDataTool = tool({
    ...
    execute: async ({ email, context }) => {
        try {
            ...
            logInfo("Email data extraction initiated", { requestId: "tool-execution" }, {
...
export const validatePolicyComplianceTool = tool({
    ...
    execute: async ({ draftText, language }) => {
        try {
            const checks = {
                has_end_of_month_policy: language === "no"
            ...
            logInfo("Policy compliance validation completed", { requestId: "tool-execution" }, {
                compliant,
                checks
            });
            try {
