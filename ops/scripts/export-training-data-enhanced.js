...
const schema_js_1 = require("@agents/db/src/schema.js");
...
async function exportForFineTuning() {
    ...
    try {
        ...
        const reviews = await db_1.db
            .select()
            .from(schema_js_1.humanReviews)
            .leftJoin(schema_js_1.tickets, (0, drizzle_orm_1.eq)(schema_js_1.humanReviews.ticketId, schema_js_1.tickets.id))
            .leftJoin(schema_js_1.drafts, (0, drizzle_orm_1.eq)(schema_js_1.humanReviews.draftId, schema_js_1.drafts.id))
            .where((0, drizzle_orm_1.eq)(schema_js_1.humanReviews.decision, "approved"))
            .limit(1000);
            ...
            messages: [
                {
                    ...
                    content: r.drafts.language === "no"
                        ? prompts_1.systemPolicyNO_Enhanced
                        : prompts_1.systemPolicyEN_Enhanced
                },
                {
                    role: "user",
